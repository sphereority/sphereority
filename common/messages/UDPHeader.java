...
/**
 *  If a UDP packet comes in, use this class to analyze the
...
public class UDPHeader extends Header{
     ...
     */
    public UDPHeader(MessageType message, int dataLength) {
    ...
    public Header getHeader(byte[] packet) {
        ...
        message = MessageAnalyzer.getMessageType(buffer.get());
        // Get the data length
    ...
    public byte[] createHeader() {
        ...
        buffer.put(MessageAnalyzer.getByteMessageType(message));
